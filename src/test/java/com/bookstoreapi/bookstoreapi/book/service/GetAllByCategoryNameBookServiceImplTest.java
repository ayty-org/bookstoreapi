...
public class GetAllByCategoryNameBookServiceImplTest {
    ...
    @Test
    void findAllTest(){
        when(bookRepository.findAllByCategoriesNameIgnoreCase(anyString())).thenReturn(allBooks);
        List<BookDTO> listReturned = getAllByCategoryNameBookService.findAllByCategoriesName("test");
